...
- property_index (command line: /property_index/): Boolean: Produce Property Index output. See README_Property_Index.md for more information about this mode.
